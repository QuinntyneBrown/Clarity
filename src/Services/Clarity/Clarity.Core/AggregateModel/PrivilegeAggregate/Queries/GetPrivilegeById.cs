...
namespace Clarity.Core.AggregateModel.PrivilegeAggregate.Queries;
...
public class GetPrivilegeByIdRequestHandler : IRequestHandler<GetPrivilegeByIdRequest, GetPrivilegeByIdResponse>
{
    ...
    public GetPrivilegeByIdRequestHandler(ILogger<GetPrivilegeByIdRequestHandler> logger, IClarityDbContext context)
    {
